...
<body>
    <center>
        <h3>NGINX Regular Expression Tester</h3>
        <br>
        <?php
...
EOT;
        ...
        <form action="" method="post">
            ...
            <table cellpadding=2 cellspacing=2>
                ...
                <tr>
                    <td align="center" colspan="2"><a href="regextester.php?test=loc">Switch to the Location tester</a>
                    </td>
                </tr>
                <?php
                }
                ...
                <tr>
                    <th align="right">Regular Expression</th>
                    <td><input type="text" name="frmRegex" value='<?php print($regex); ?>' size=80></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>Enter the regular expression exactly as it will appear in the NGINX configuration,</i></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>not including the '~' or '~*'. If there are spaces in the regular expression, it</i></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>must be enclosed in single or double quotes.</i></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td><input type="checkbox" name="frmCaseSensitive" value="1" <?php print($cbChecked); ?>></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>/<input type="text" name="frmValueToTest" value='<?php print($valueToTest); ?>' size=80></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>Enter the URI after the domain or IP address.</i></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>For example, if the full URI is http://foo.com/abc/bar.ph, enter abc/bar.php.</i></td>
                </tr>
                <?php
                } else {
                    ?>
                <tr>
                    <th align="right">Value to test</th>
                    <td><input type="text" name="frmValueToTest" value='<?php print($valueToTest); ?>' size=80></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>Enter the value to be evaluated by the Map</i></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <th align="right">Value to set</th>
                    <td><input type="text" name="frmValueToSet" value='<?php print($valueToSet); ?>' size=80></td>
                </tr>
                <tr>
                    <td>
                        </th>
                    <td><i>Enter the value to be set by the Map if there is a match</i></td>
                </tr>
                <?php
                }
                ?>
                ...
                if ($result != '') {
                    ?>
                <tr>
                    <th align="right" valign="top">Result</th>
                    <td><textarea rows="2" cols="80" readonly><?php print($result); ?></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <?php
                    ...
                    ?>
                <tr>
                    <th align="right" valign="top" rowspan="2">Generated<br>Configuration</th>
                    <td><textarea rows="<?php print(substr_count($config, "\n") + 1); ?>" cols="80"
                            readonly><?php print($config); ?></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>

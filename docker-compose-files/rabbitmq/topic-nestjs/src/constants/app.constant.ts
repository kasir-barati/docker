...
// #: matches zero or more words, e.g., “metrics.#” will match all routing keys that start with “metrics.”
// *: matches one word, for example, “metrics.*.cpu” will match all routing keys that start with “metrics.” and end in “.cpu”.

...
export async function getConfig() {
    ...
    const clientId = await readFile(join(clientDir, "integration-test-book-app-id"), "utf-8");
    const clientSecret = await readFile(join(clientDir, "integration-test-book-app-secret"), "utf-8");
